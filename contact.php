      ...
      <div class="container-hld">
        <div class="lf col">
          ...
          <form action="">
            ...
            <div class="input">
              <label for="CompanyName" class="CompanyName in"
                >Company Name</label
              >
              <input
                type="text"
            ...
            <div class="input">
              <label for="services" class="services required-field in bt-0"
                >Services</label
              >
              <select name="services" id="services" multiple required>
                <option value="Comprehensive Fashion Design & Development">
                  Comprehensive Fashion Design & Development
                </option>
                <option value="Hourly-Consulting">Hourly Consulting</option>
                <option value="Concept-Trend-Line-Plan,-Merchandising">
                  Concept, Trend, Line Plan, Merchandising
                </option>
                <option value="Footwear">
                  Brand Development (logo, messaging, website, photoshoots,
                  etc...
                </option>
              </select>
            </div>
            <div class="input">
              <label for="services" class="services in bt-0"
                >Desired Launch Date</label
              >
            ...
            <div class="input">
              <label
                for="Distribution"
                class="Distribution required-field in bt-0"
                >Distribution</label
              >
              <select name="Distribution" id="Distribution" required>
                <option value="Direct-to-Consumer">Direct to Consumer</option>
                <option value="Wholesale">Wholesale</option>
                <option value="Havent-Decided-Yet">Haven't Decided Yet</option>
              </select>
            </div>
            <div class="input">
              <label for="Message" class="Message required-field in bt-0"
                >Message</label
              >
            ...
            <div class="input">
              <label for="Reach" class="Reach in bt-0"
          ...
          <div class="info-contacts">
            <div class="con">
              <a href="tel:+212661173921"
                >Call center: <span><b>212 661 173921</b></span></a
              >
              <a href="mailto:hello@fashionExpertise.agency" class="email"
                >hello@fashionExpertise.agency</a
              >
            </div>
            <div class="con">
