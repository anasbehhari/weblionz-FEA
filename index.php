...
<body>
  ...
  <section id="Header-section">
    ...
    <div class="container">
      <ul class="social-media">
        ...
        <li class="likendin nm">
          <a href="">
            <svg class="facebook" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 310 310" style="enable-background: new 0 0 310 310" xml:space="preserve">
              <g id="XMLID_834_">
    ...
    <div class="scroll nm">
      ...
      <svg width="12" height="36" viewBox="0 0 12 36" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M6.07117 35.9957L11.8447 25.9957H0.297665L6.07117 35.9957ZM7.07117 26.9957L7.07117 0.99573H5.07117L5.07117 26.9957H7.07117Z" fill="white" />
      </svg>
    </div>
    <div class="video">
  ...
  <section id="whyus" data-aos="fade">
    <div class="container-section">
      ...
      <div class="text-container">
        ...
        <p class="description">
          <b> Fashion expertise agency</b> Core Work is Fashion Design, we offer more than one service in creation, Labeling, researches and development, Textile and clothing, etc.<br />
          It's been a universe specialized in creation, with an Automatized system for Research and development, Sketching and creation, it exists to facilitate the designing and give an access to all research in an efficient way which is Smart for us to spread
        </p>
  ...
  <section id="ourservices" data-aos="fade">
    ...
    <p>We offer more than one service destined to all the providers of fashion and apparel manufacturers, in order to be informed of the latest trends, ideas and creations divided in personalized services depending on the client’s need, starting from Analyzing, reporting, creating, conception and finally shipped.
    </p>
    <div class="grid">
    ...
    <div class="text-display">
      <div class="qut">
        <svg width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M26.968 30.7583C29.8583 30.8567 32.2848 28.5205 32.3859 25.5396C32.4868 22.5606 30.2242 20.0629 27.3339 19.9646C22.1008 19.7864 25.9426 9.47297 32.9224 9.71056L33.0078 7.19201C20.5508 6.76618 14.8646 30.3463 26.968 30.7583V30.7583ZM11.8881 30.245C14.7766 30.3433 17.2031 28.0071 17.3041 25.0263C17.4051 22.0472 15.1425 19.5496 12.254 19.4512C7.01906 19.2731 10.8608 8.9596 17.8407 9.19719L17.9261 6.67864C5.4708 6.25287 -0.215393 29.833 11.8881 30.245V30.245Z" fill="white" fill-opacity="0.82" />
        </svg>
      </div>
      <h1>
        Created with passion, the Fashion expertise agency is based on working with a new approach in the Management of designing in the Fashion Industry.
      </h1>
      <div class="qut">
        <svg width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M26.968 30.7583C29.8583 30.8567 32.2848 28.5205 32.3859 25.5396C32.4868 22.5606 30.2242 20.0629 27.3339 19.9646C22.1008 19.7864 25.9426 9.47297 32.9224 9.71056L33.0078 7.19201C20.5508 6.76618 14.8646 30.3463 26.968 30.7583V30.7583ZM11.8881 30.245C14.7766 30.3433 17.2031 28.0071 17.3041 25.0263C17.4051 22.0472 15.1425 19.5496 12.254 19.4512C7.01906 19.2731 10.8608 8.9596 17.8407 9.19719L17.9261 6.67864C5.4708 6.25287 -0.215393 29.833 11.8881 30.245V30.245Z" fill="white" fill-opacity="0.82" />
    ...
    <div class="testimonial-quotes">
      ...
      <div class="partners">
        ...
        <a href="#" target="_blank" class="partner">
          <img src="media/images/partners/TRE.png" alt="">
        </a>
        <a href="#" target="_blank"" class="partner">
          ...
          <div class="link">
            <a href="contact.php" class="contact">
              <span>
                ...
                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 495.003 495.003" style="enable-background:new 0 0 495.003 495.003;" xml:space="preserve">
                  <g>
    ...
    <div class="container-footer">
      ...
      <div class="about-us section">
        <div class="center">
          ...
          <p class="description">
            <b>FashionExpertise Agency</b> Have mush planned for the future, working with great clients and continued Fashion industry. If you’d like to join our team.
          </p>
