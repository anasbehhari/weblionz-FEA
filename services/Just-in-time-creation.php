...
<head>
    ...
    <title> Welcome to FashionExpertise.agency — Fashion Design & Consulting | Reaserches and Developement Service </title>
...
<body>
    ...
    <section id="Header">
        <img class="back" src="../media/images/brand-1.png" alt="">
        <header class="header">
            <div class="logo">
                <a href="../">
                    <img src="../media/logo.svg" alt="" />
    ...
    <main>
        <div class="text-section">
            <h1>We are designing everyday you are selling everyday.</h1>
        </div>
        ...
        <div class="options-offers">
            <div class="option">
                <h3>option 1</h3>
                <p>
                    The client is free to give us his inspirational pictures, which leads us to develop
                    the idea seen in new perspectives proposed in different: <u>
                        shapes / Styling / colors
                        and fabrics, or yarns when it comes to a knit development.
                    </u>

                </p>
                <p>
                    which means that this garment is delivered in forms of a Sketch with file that
                    contains :
                </p>
                <ol>
                    <li>
                    ...
                    <li>
                        One colors composition by sketch
                    </li>
                </ol>
                <p>
                    Once the sketch is confirmed, the client is free to pay for it or to ask for a
                    technical file that will be filled with all the information about the design that you
                    can read below:
                </p>
                ...
                <ol>
                    ...
                    <li>
                        Fabric composition / or yarns quality
                    </li>
                    <li>
                        3 to 8 colors proposition depending on the Style
                    </li>
                </ol>
            </div>
            <div class="option">
                <h3>option 2</h3>
                <p>
                    The client if free to ask for designs made in FEA adapted to his identity, when
                    it’s he really needs a new punch of originality and creativity in his sales outlet,
                    it’s a sort of limited edition to get the customer attention to improve sales for
                    a period of low selling, for example or just need up-dating in his collection, and
                    in Buzz periods
                </p>
                <p>
                    In this case FEA will be the one doing the research and propose 100% Style:
                </p>
                <p>
                    We can make it also easier for the client for his production process by making
                    the constructive file with more details that contains :
                </p>
                <ol>
                    <li>Measurments of each part of the design</li>
                    <li>Real size of print with placement</li>
                </ol>
                </p>
            </div>
            <div class="option">
                <h3>option 3</h3>
                <p>
                    The client is free to ask for Inspirational reports made for a particular family
                    product or multiple families depending on his needs.
                    FEA will took in charge in this case, a global research on the family product,
                    and send a Report that contains:
                </p>
                <p>
                    Ideas Direction for the family product :
                </p>
                <ol>
                    <li>Styling</li>
                    <li>fit/target/season/ </li>
                    <li>Description</li>
                    <li>from 8 To 12 ideas</li>
                </ol>
            </div>
            <div class="option">
                <h3>option 4</h3>
                <p>
                    Mood Board : FEA will took in charge in this case, a global research on the
                    family product, and send a mood board that contains:
                </p>
                ...
                <ol>
                    ...
                    <li>Accessories</li>
                    <li>Color range </li>
                    <li>Commercial key words</li>
                </ol>
                <p>
                    If the client confirms the Mood board, he is free to pay it, or ask for a capsule
                    designed and inspired from the Universe of the Mood Board.z
                </p>
            </div>
        </div>
        <div class="links">
        ...
        <div class="container-footer">
            ...
            <div class="about-us section">
                <div class="center">
                    ...
                    <p class="description">
                        <b>FashionExpertise Agency</b> Have mush planned to the future,working with great clients and
                        continued
                        Fashion
                    ...
                    <li>
                      <a href="mailto:hello@fashionExpertise.agency">
                        ...
                        >
                          ...
                          />
                          <path
                            d="M7.99998 7.34041L15.0344 2.18169L0.965332 2.18164L7.99998 7.34041Z"
                            fill="white"
                          />
                        </svg>
